export const config = {
	mapTitle: 'sexual-education', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'https://map-sexual-education.vercel.app/', // The url provided when deploying the map on Vercel
